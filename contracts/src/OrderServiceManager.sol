...
import "./interface/IOrderServiceManager.sol";

/**
 * @title Primary entrypoint for procuring services from HelloWorld.
 * @author Eigen Labs, Inc.
 */
contract OrderServiceManager is
    ECDSAServiceManagerBase,
    IOrderServiceManager,
    Pausable
{
    ...
    mapping(address => mapping(uint32 => bytes)) public allOrderResponses;
    ...
    function createNewOrder() external {
